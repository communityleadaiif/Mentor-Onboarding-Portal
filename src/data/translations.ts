...
export const TRANSLATIONS: Record<Language, Record<string, string>> = {
  en: {
    ...
    regCloses: 'Registration Closes Aug 15',
    ...
    beneficiaries: '8. Potential Beneficiaries Paragraph',
  ...
  ta: {
    ...
    regCloses: 'பதிவு முடிவு: ஆகஸ்ட் 15',
    ...
    guideTeacherPhone: 'ஆசிரியர் தொலைபேசி எண்ணை',
